...
var responsiveImages = (function ($) {
    ...
    return function (responsiveDesign) {
        $("img[width]").each(function () {
            var img = $(this);
            var inBlock = parseFloat(img.hide().parent().width()) !== 0;
            img.show();
            var newWidth = "", newMaxWidth = responsiveDesign.isResponsive && !inBlock ? 'none' : '', newHeight = "";
            if (responsiveDesign.isResponsive && inBlock) {
                newWidth = "auto";
                newHeight = "auto";
                newMaxWidth = "100%";
